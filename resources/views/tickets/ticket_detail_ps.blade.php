...
<head>
    ...
    <style>
        ...
        td { border:1px solid #333; padding:8px; background:#eef7c4; }
        .btn { display:block; margin:6px 0; padding:6px; background:#8bc34a; border:1px solid #333; text-decoration:none; color:#000; text-align:center; }
        /* MODAL */
        .overlay { position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.2); }
        .modal { width:320px; margin:120px auto; background:#cfd8c3; border:1px solid #333; padding:15px; text-align:center; }
    </style>
</head>
<body>
